...
Aspiring.AutoSave.SaveTimeout = 1000; // 10 seconds
...
SocialCalc.Callbacks.editAutoSave = function() {
    ...
    if (Aspiring.AutoSave.autoSaveTimeoutId != null) {
       ...
       Aspiring.AutoSave.autoSaveTimeoutId = window.setTimeout(Aspiring.AutoSave.TimerExpiry, Aspiring.AutoSave.SaveTimeout);
    }
...
Aspiring.AutoSave.TimerExpiry = function() {
    ...
    var appGeneral = new AppGeneral();
    appGeneral.updateFileName(Aspiring.AutoSave.selectedFile);
