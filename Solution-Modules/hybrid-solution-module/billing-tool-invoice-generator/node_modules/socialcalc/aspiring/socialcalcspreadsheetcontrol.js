...
SocialCalc.InitializeSpreadsheetControl = function(spreadsheet, node, height, width, spacebelow) {
   ...
   html = '<div><div style="'+spreadsheet.toolbarbackground+'padding:0px;height:0px;display:none;">';
   ...
   html += '</div>'+
      '<div style="'+spreadsheet.tabbackground+'padding-bottom:0px;margin:0px 0px 8px 0px;display:none;">'+
